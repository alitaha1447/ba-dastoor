        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start relative z-10">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="order-1 lg:order-2">
              ...
              {/* Branches */}
              <div className="space-y-4 text-sm text-[#615751] max-h-[220px] overflow-y-auto scrollbar-thin-custom p-2 rounded-lg">
                {branches.map((branch, index, arr) => {
                  ...
                  return (
                    <div
                      ...
                      className={`cursor-pointer  p-2 pb-2 hover:bg-gray-200 ${
                        index !== arr.length - 1
                          ? "border-b border-[#E6DED4]"
                          : ""
                      }`}
                    >
          ...
          <div className="order-1 lg:order-2 bg-[#6F6A68] rounded-2xl px-6 py-10 sm:px-10 shadow-lg">
            ...
            >
              ...
              <div className="relative">
                ...
                />
                <label
                  className="absolute left-3 top-2 text-white text-xs px-2
      peer-focus:-top-2 peer-focus:text-xs peer-focus:text-gold
      peer-valid:-top-2 peer-valid:text-xs bg-[#6f6a68] px-1 transition-all rounded-xl"
                >
                  Event Date
                </label>
              </div>
              ...
              <div className="sm:col-span-2 flex justify-center mt-4">
                <button
                  type="submit"
                  disabled={isLoading}
                  className={`catering-btn flex items-center justify-center gap-2 ${
