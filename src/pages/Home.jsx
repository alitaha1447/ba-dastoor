...
const Home = () => {
    ...
    useEffect(() => {
        Promise.all([
            axios.get(`https://ba-dastoor-backend.onrender.com/api/generalContent/get-content?page=${page}`),
            axios.get(`https://ba-dastoor-backend.onrender.com/api/categories/get-categorywithdishes`)
