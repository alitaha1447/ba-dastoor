...
export default function GoogleReviewsCarousel({ reviewCounts, avgRating, reviews }) {
                ...
                <div className="overflow-hidden">
                    ...
                    >
                        {reviews.map((review) => (
                            ...
                            >
                                <div className="bg-white rounded-2xl p-6  border border-[#f1e6d3] shadow-sm hover:shadow-md transition">
                                    {/* Reviewer */}
                                    ...
                                    <p className="mt-4 text-xs text-gray-400">
                                        {new Date(review.
                                            createTime).toLocaleDateString("en-IN", {
                                                day: "numeric",
                                                month: "short",
                                                year: "numeric",
                                            })}
